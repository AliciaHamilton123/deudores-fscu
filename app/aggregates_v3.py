...
interesante.append({
    ...
    "eli5": "77,2% de los deudores 2026 (258.596 personas) figuraron sin interrupción en las cinco nóminas desde 2022. Sólo el 3,9% (13.174) son ingresos nuevos sin antecedentes previos. La morosidad no responde a un evento coyuntural: el mismo universo de personas permanece impago año tras año, y los mecanismos de recuperación no logran reducir el grupo base.",
    "tipo": "chronic"
})
...
interesante.append({
    ...
    "eli5": "La cartera vencida del FSCU creció 54,4% en UTM entre 2022 y 2026 (de 37,3M a 57,5M UTM). En el mismo período, la inflación acumulada fue de ~12%. La morosidad se expande 4,5 veces más rápido que el nivel general de precios, impulsada por intereses capitalizados e ingresos netos de nuevos deudores. Los mecanismos actuales de recuperación no alcanzan a contener la brecha.",
    "tipo": "interest"
})
...
interesante.append({
    ...
    "desc": "En cada transición anual, los nuevos deudores superan a quienes pagan y salen: 2022→2023 ingresaron 30.903 y salieron 11.146 (saldo +19.757). 2023→2024: +10.596. 2024→2025: +13.937. 2025→2026: +2.650. Total acumulado: +93.024 nuevos deudores netos. En paralelo, entre 260.000 y 302.000 deudores por año sólo acumulan intereses sin abonar capital. La cartera se expande sin un mecanismo efectivo de contención.",
    "eli5": "En cada transición anual, los ingresos superan a las salidas: +19.757 entre 2022 y 2023, +10.596 en 2023-2024, +13.937 en 2024-2025, +2.650 en 2025-2026. Saldo neto acumulado: +93.024 deudores en cuatro años. Entre 260.000 y 302.000 deudores por año permanecen en la nómina sólo acumulando intereses, sin amortización de capital.",
    "tipo": "flow"
})
...
interesante.append({
    ...
    "eli5": "El perfil mayoritario de los morosos FSCU es hombre (54,9%), con mediana de edad en el tramo 35-44 años — consistente con egresados a 10-15 años de la titulación. El NSE predominante es Medio Alto, seguido de Medio. Pese a que las mujeres representan ~52% de la matrícula universitaria chilena, los hombres son mayoría entre quienes mantienen la deuda impaga.",
    "tipo": "demographics"
})
...
interesante.append({
    ...
    "eli5": "6.969 deudores (2,1%) figuran en la nómina 2026 con saldo activo en dos o más universidades del CRUCH. La Ley 19.287 habilita tomar créditos en distintas instituciones durante la trayectoria académica; estas personas egresaron con obligaciones simultáneas y las mantienen impagas en más de un establecimiento.",
    "tipo": "multi"
})

# 14. Ultra ricos
interesante.append({
    "titulo": "Decil 10 con deuda alta",
    "kpi": "251",
    "sub": "Decil 10 de avalúo + deuda >1.000 UTM (≈$70M CLP)",
    "desc": "251 deudores están en el decil 10 de avalúo fiscal (máxima riqueza declarada ante el SII) y simultáneamente tienen una deuda individual superior a 1.000 UTM — aproximadamente $70 millones CLP o más. Son el extremo superior del universo moroso: patrimonio suficiente para saldar la deuda varias veces, combinado con exposición FSCU significativa sin pagos registrados.",
    "eli5": "251 deudores combinan decil 10 de avalúo fiscal (máximo patrimonio declarado ante el SII) con saldo individual superior a 1.000 UTM (≈$70 millones CLP). Representan el extremo superior del universo moroso: patrimonio suficiente para saldar la deuda y, simultáneamente, exposición FSCU significativa sin pagos registrados.",
    "tipo": "ultra"
})
...
interesante.append({
    ...
    "eli5": "247.300 deudores (73,8% del 2026) figuraron en las cinco nóminas consecutivas y su saldo en UTM creció más de 5% en ese período. La mediana pasó de 81 UTM en 2022 a 152 UTM en 2026: un aumento del 87%. Los intereses legales del FSCU se capitalizan a ritmos que superan con creces la inflación, expandiendo el saldo individual al margen de cualquier amortización.",
    "tipo": "chronic"
})
...
interesante.append({
    ...
    "eli5": "La suma del avalúo fiscal de propiedades y la tasación de vehículos registrados ante el SII para los 335.152 deudores alcanza $7,19 billones CLP — casi el doble de la cartera FSCU vencida ($4,02 billones). Propiedades aportan $5,95 billones; vehículos, $1,24 billones. El patrimonio agregado del grupo cubre con holgura el saldo adeudado.",
    "tipo": "wealth"
})
...
interesante.append({
    ...
    "eli5": "La deuda mediana de los 247.300 deudores crónicos creció 87,3% en cuatro años: 81,2 UTM (2022) → 98,7 → 117,4 → 133,9 → 152,1 UTM (2026). La inflación acumulada del período fue cercana al 12%. La brecha se explica por el régimen de intereses legales del FSCU, que capitaliza el saldo sin requerir amortización: el monto adeudado aumenta al margen de la trayectoria económica del deudor.",
    "tipo": "interest"
})
...
interesante.append({
    ...
    "desc": "Uno de cada cinco deudores morosos del Fondo Solidario (64.044 personas, 19,1% del total) tiene simultáneamente al menos una propiedad y al menos un vehículo registrados ante el SII/Servel. El perfil no coincide con el supuesto común de insolvencia asociado al crédito universitario impago: corresponde a profesionales con patrimonio establecido. El impago persiste pese a la capacidad declarada de respaldo.",
    "eli5": "64.044 deudores (19,1% del total) tienen simultáneamente al menos una propiedad y al menos un vehículo registrados ante el SII/Servel. El perfil no se ajusta al supuesto de insolvencia comúnmente asociado al crédito universitario impago: corresponde a profesionales con patrimonio establecido. La morosidad persiste pese a la capacidad declarada de respaldo.",
    "tipo": "wealth"
})
...
interesante.append({
    ...
    "desc": "La comuna de Santiago (distinta de la Región Metropolitana) concentra 11.124 deudores FSCU — el primer lugar del ranking comunal nacional. Es una comuna de tamaño mediano (menos de 400.000 habitantes) pero con alta concentración de población universitaria, incluidos egresados que residen en el sector céntrico. Le siguen comunas densamente pobladas como Maipú, Puente Alto, La Florida y Ñuñoa, donde se concentra parte relevante de la clase media profesional chilena.",
    "eli5": "La comuna de Santiago concentra 11.124 deudores FSCU, el mayor volumen del ranking comunal nacional. Es una comuna de tamaño mediano (menos de 400.000 habitantes) con alta densidad de población universitaria, especialmente egresados que residen en el sector céntrico. Le siguen Maipú, Puente Alto, La Florida y Ñuñoa, comunas con fuerte presencia de clase media profesional.",
    "tipo": "demographics"
})
